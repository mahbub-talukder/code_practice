...
1) R is "a" or "b".
2) R is of the form "(Ry R₂)", where R1 and R2 are regular expressions.
...
3) If R is of the form "(R1 R2)" then the set of strings recognized = all strings which can be obtained by a concatenation of strings $1 and 82, where 81 is recognized by R₁ and s₂ by R2.
4) If R is of the form "(R1 R2)" then the set of strings recognized = union of the set of strings recognized by R₁ and R₂
5) If R is of the form "(R1)" then the the strings recognized are the empty string and the concatenation of an arbitrary number of copies of any string recognized by R₁
