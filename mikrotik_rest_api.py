...
apiURL = 'http://103.161.68.200/rest' # Please enter your IP address 
apiUsername = 'devops_test' # Input your username here 
apiPassword = 'devops' # Input your password here 


def res_api():
    response = requests.get(apiURL+'/ppp/active', auth=HTTPBasicAuth(apiUsername, apiPassword), verify=False)
